...
import org.knowm.configuration.ConfigurationParsingException;
...
public class LevenshteinComparatorTest {
   ...
   *
   * <p>It is triggered by a certain condition in TimSort that only happens if 32 or more values are
   * in an array. As such, it may not be a thorough test... it depends on the specifics of the
   * environment / JVM.
   */
  @Test
